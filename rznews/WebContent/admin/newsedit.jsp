				...
				<tr>
					<td class="lable">类别</td><td>
					    ...
					    <select name="typename">
					    	<option <%=(objbyid.get("typeid").equals("1"))?"selected=\"selected\"":""%> value="1">今日通知</option>
					    	<option <%=(objbyid.get("typeid").equals("2"))?"selected=\"selected\"":""%> value="2">周边趣事</option>
					    	<option <%=(objbyid.get("typeid").equals("3"))?"selected=\"selected\"":""%> value="3">餐饮文化</option>
					    </select>
				    </td>
				</tr>

...
<html>
	...
	<div class="header">
		<ul>
			...
			<li><a href="showlist?typeid=1">酒店简介</a></li>
			<li><a href="showlist?typeid=2">房间预订</a></li>
			<li><a href="showlist?typeid=3">酒店通知</a></li>
			<li><a href="showlist?typeid=4">客户评价</a></li>
			<li><a href="newslist">联系我们</a></li>
		</ul>
	</div>
	<div class="main">

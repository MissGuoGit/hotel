...
<body>
<%
List<Map<String, Object>> list = (List<Map<String, Object>>)request.getAttribute("roomslist");
...
<table border="0" cellspacing="0" cellpadding="0" class="tb tblis">
       <tr>
       	 <td style="width:10px;">ID</td><td style="width:80px;">房间号</td><td style="width:80px;">房间名称</td><td style="width:80px;">房间类别</td><td style="width:80px;">房间价格</td><td style="width:80px;">是否入住</td><td style="width:80px;">是否推荐</td><td style="width:80px;">操作</td>   
       </tr>
       <% for(Map<String, Object> m:list){ %>
        <tr>
       		...
       		<td><%=m.get("isshow").toString().equals("1")?"已推荐":"未推荐"%></td>
       		<td><a href="checkon?id=<%=m.get("id")%>">首页推荐</a> <a href="checkoff?id=<%=m.get("id")%>">取消推荐</a></td>
       </tr>
    	<% } %>
    </table>

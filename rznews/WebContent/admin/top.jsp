...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<body>
		<form name="form1" method="post" action="top.aspx" id="form1">
			<div class="linear">
				<img src="../img/houtai1.jpg" style="height:100px; weith:1400px" />
			</div>
			<ul class="nav">
                        ...
                        <li>
					        <a href="left.jsp?id=2" target="left">酒店管理</a>
				        </li>
                    
                        <li>
					        <a href="left.jsp?id=3" target="left">用户信息管理</a>
				        </li>
                    
                        <li>
					        <a href="left.jsp?id=4" target="left">留言管理</a>
				        </li>  
				        <li>
					        <a href="left.jsp?id=5" target="left">酒店通知</a>
				        </li>  
				        <li>
			...
			<div class="timeanduser">
				...
				<p id="currentuser">当前用户: 【admin】<a href="login.jsp" target="_top" id="logout" title="退出系统"><img src="../img/logout5.png"></a> </p>
			</div>
		</form>

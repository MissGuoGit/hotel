...
<html>
	...
	<body>
		...
		<div class="menu">
			...
			<div class="rightlist">
			<div>
				<form action="uiassessadd" method="post" style="padding-left: 30px; margin-top: 10px;";>	  			
			<table border="0" cellspacing="0" cellpadding="0" class="hotel" class="tb">
				<tr><td class="right" style="border-right: none;"><span>姓名:</span></td><td style="border-left: none;"><input type="text" id="text" name="username"/></td></tr>
				<tr><td class="right" style="border-right: none;"><span>电话号码:<span></span></td><td style="border-left: none;"><input type="text" id="text" name="tel"/></td></tr>
				<tr>
					<td class="right" style="border-right: none;">评价：</td><td>
				...
				<tr><td class="right" style="border-right: none;"><span>详细评论：</span></td><td style="border-left: none;"><textarea rows="10" cols="50" name="detil"></textarea></tr>
				<tr><td class="right" style="border-right: none;"></td><td style="border-left: none;"><input type="submit" name="button" id="button" value="提交">	
